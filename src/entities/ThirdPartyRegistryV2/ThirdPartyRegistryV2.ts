...
export class ThirdPartyRegistryV2__itemsByIdResultValue0Struct extends ethereum.Tuple {
  get metadata(): string {
...
export class ThirdPartyRegistryV2__thirdPartiesResult {
  value0: boolean;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
...
export class ThirdPartyRegistryV2 extends ethereum.SmartContract {
  static bind(address: Address): ThirdPartyRegistryV2 {
    return new ThirdPartyRegistryV2("ThirdPartyRegistryV2", address);
  }
  ...
  itemsById(
    _thirdPartyId: string,
    _itemId: string
  ): ThirdPartyRegistryV2__itemsByIdResultValue0Struct {
    let result = super.call(
      "itemsById",
    ...
    return changetype<ThirdPartyRegistryV2__itemsByIdResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_itemsById(
    _thirdPartyId: string,
    _itemId: string
  ): ethereum.CallResult<ThirdPartyRegistryV2__itemsByIdResultValue0Struct> {
    let result = super.tryCall(
      "itemsById",
      "itemsById(string,string):((string,string,bool,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<ThirdPartyRegistryV2__itemsByIdResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  thirdParties(param0: string): ThirdPartyRegistryV2__thirdPartiesResult {
    let result = super.call(
      "thirdParties",
    ...
    return new ThirdPartyRegistryV2__thirdPartiesResult(
      result[0].toBoolean(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_thirdParties(
    param0: string
  ): ethereum.CallResult<ThirdPartyRegistryV2__thirdPartiesResult> {
    let result = super.tryCall(
      "thirdParties",
      "thirdParties(string):(bool,bytes32,uint256,uint256,uint256,string,string)",
      [ethereum.Value.fromString(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ThirdPartyRegistryV2__thirdPartiesResult(
        value[0].toBoolean(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt(),
